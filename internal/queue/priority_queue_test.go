...
import (
	...
	gutil "github.com/DaHuangQwQ/gutil"
...
func TestPriorityQueue_Shrink(t *testing.T) {
	var compare gutil.Comparator[int] = func(a, b int) int {
		if a < b {
			return -1
		}
		if a == b {
...
func priorityQueueOf(capacity int, data []int, compare gutil.Comparator[int]) *PriorityQueue[int] {
...
func compare() gutil.Comparator[int] {
